...
#include "common.h"
#line HEADER_FILE("mac/pid_finder.h")
...
public:
    ...
    QSet<pid_t> pids();
    QSet<quint16> ports(const QSet<pid_t> &pids, IPVersion ipVersion);
...
//private:
    ...
    void findPidAddresses(pid_t pid, IPVersion ipVersion, Func_T func);
